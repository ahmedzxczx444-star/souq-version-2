...
export const translations = {
  en: {
    ...
    invalidEgyptPhone: "Please enter your phone number without the leading zero and without the country code.",
  ...
  ar: {
    ...
    invalidEgyptPhone: "من فضلك أدخل رقم الهاتف بدون الصفر في البداية وبدون كود الدولة.",
